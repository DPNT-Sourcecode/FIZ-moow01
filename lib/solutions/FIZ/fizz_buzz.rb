...
class FizzBuzz
  ...
  def fizz_buzz(number)
    ...
    elsif (number > 10 && (number.to_s.split('').uniq.count <= 1)) && ((number % 15 == 0) || (number % 3 == 0 && number.to_s.include?('5')) || (number % 5 == 0 && number.to_s.include?('3')) || (number.to_s.include?('3') && number.to_s.include?('5')))
